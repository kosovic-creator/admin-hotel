...
export default function Nav({ isSidebarOpen, setIsSidebarOpen }: NavProps) {
  ...
  return (
    <div className="w-full">
      <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-gray-500 to-gray-900 text-white shadow-lg rounded-b-xl px-6 py-4">
        <nav>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div
                className={`flex gap-4 transition-all duration-300 text-stone-200 ${isSidebarOpen ? "ml-30" : ""
                  }`}
              >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-xs px-3 py-1 rounded-full font-semibold tracking-wide  text-stone-200">
